      ...
      <ScrollView style={styles.categoriesList}>
        ...
        <View style={styles.tipsCard}>
          ...
          <Text style={styles.tipItem}>
            • You're close to your Dining Out limit - consider meal prepping
          </Text>
          <Text style={styles.tipItem}>
            • Great job! You've stayed under budget in 4 categories
          </Text>
          <Text style={styles.tipItem}>
            • Your Utilities budget is fully spent - no room for overage
          </Text>
        </View>
