  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>💰 Your Savings Dashboard</Text>
      ...
      <View style={styles.heroCard}>
        ...
        <View style={styles.heroBadge}>
          <Text style={styles.heroBadgeText}>🎉 Outstanding Performance!</Text>
        </View>
      </View>
      ...
      <View style={styles.comparisonCard}>
        ...
        <View style={styles.comparisonInsight}>
          <Text style={styles.insightText}>
            💡 You're spending <Text style={styles.insightHighlight}>{percentageSaved}% less</Text>{' '}
      ...
      {timeframe !== 'year' && (
        <View style={styles.projectionCard}>
          <Text style={styles.projectionTitle}>📈 Projected Annual Impact</Text>
      ...
      <View style={styles.meterCard}>
        ...
        <Text style={styles.ratingText}>
          {parseFloat(percentageSaved) >= 30
            ? "🌟 Excellent! You're a savings superstar!"
