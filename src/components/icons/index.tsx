...
// Location/Pin Icon
export const LocationIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
...
// Phone Icon
export const PhoneIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const NavigationIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// Link/External Icon
export const LinkIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Search Icon
export const SearchIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// List Icon
export const ListIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// Folder/Group Icon
export const FolderIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Map Icon
export const MapIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Checkmark Icon
export const CheckIcon: React.FC<IconProps> = ({size = 20, color = '#059669', strokeWidth = 3}) => (
...
export const AlertStarIcon: React.FC<IconProps & {alertType?: 'critical' | 'warning' | 'success' | 'info'}> = ({
  size = 20,
  alertType = 'critical',
}) => {
  const colorMap = {
...
// Target/AI Icon
export const TargetIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 3}) => (
  <Svg width={size} height={size} viewBox="0 0 48 48" fill="none">
...
// Store/Building Icon  
export const StoreIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Filter Icon
export const FilterIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// ChevronDown Icon
export const ChevronDownIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// ChevronRight Icon
export const ChevronRightIcon: React.FC<IconProps> = ({size = 20, color = '#5159B0', strokeWidth = 2.5}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
