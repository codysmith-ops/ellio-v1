...
export const typography = {
  ...
  subtitle: {fontSize: 18, fontWeight: '600' as const, lineHeight: 24, fontFamily: 'Inter-SemiBold'},
  body: {fontSize: 16, fontWeight: '400' as const, lineHeight: 24, fontFamily: 'Inter-Regular'},
  bodyBold: {fontSize: 16, fontWeight: '600' as const, lineHeight: 24, fontFamily: 'Inter-SemiBold'},
  secondary: {fontSize: 14, fontWeight: '400' as const, lineHeight: 20, fontFamily: 'Inter-Regular'},
  label: {fontSize: 12, fontWeight: '400' as const, lineHeight: 16, fontFamily: 'Inter-Regular', textTransform: 'uppercase' as const, letterSpacing: 1},
